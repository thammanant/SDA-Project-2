public class LunchBuilder extends MealBuilder{
    ...
    public void buildSingleDish(String dish){
        switch (dish) {
            case "1":
                this.lunchDish = "\nCurried Chickpea Salad: A protein-packed bowl filled with fluffy chickpeas tossed in a creamy curry sauce with chopped vegetables like red bell pepper, cucumber, and red onion. Served on a bed of mixed greens with a drizzle of tangy yogurt dressing.";
                break;
    ...
    public void buildAppetizer (String dish){
        switch (dish) {
            case "1":
                this.lunchDish = "\nCaprese Skewers with Balsamic Glaze: Bite-sized mozzarella balls, cherry tomatoes, and fresh basil leaves  skewered together and drizzled with a sweet and tangy balsamic glaze. Light and refreshing to start your lunch.";
                break;
            case "2":
    ...
    public void buildMainDish (String dish){
        switch (dish) {
            case "1":
                this.lunchDish = this.lunchDish + "\nLemon Garlic Shrimp with Zucchini Noodles: Juicy shrimp sautéed in a fragrant lemon garlic sauce served over a bed of zucchini noodles. A healthy and flavorful combination perfect for a light lunch.";
                break;
            case "2":
