public class LunchBuilder extends MealBuilder{
    ...
    public void buildMainDish (String dish){
        switch (dish) {
            case "1":
                this.lunchDish = "Lemon Garlic Shrimp with Zucchini Noodles-  Juicy shrimp sautéed in a fragrant lemon garlic sauce served over a bed of zucchini noodles. A healthy and flavorful combination perfect for a light lunch.";
                break;
            case "2":
                this.lunchDish = "Chicken Caesar Wrap- Grilled chicken breast strips tossed in a light Caesar dressing with crisp romaine lettuce, Parmesan cheese, and crunchy croutons all wrapped up in a whole wheat tortilla. A classic and satisfying lunch option.";
                break;
            case "3":
                this.lunchDish = "Lentil Soup with a Crusty Roll** - A hearty and comforting soup simmered with lentils, vegetables, and herbs. Served with a crusty roll for dipping. A vegetarian option packed with protein and fiber.";
                break;
