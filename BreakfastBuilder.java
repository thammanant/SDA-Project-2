public class BreakfastBuilder extends MealBuilder {
   ...
   public void buildFullEnglish(String dish){
        switch (dish) {
            case "1":
                this.breakfastDish = "\nSunshine Scramble: Fluffy scrambled eggs with vibrant chopped peppers, melty cheddar cheese, and a dollop of cool sour cream.";
                break;
            case "2":
   ...
   public void buildLightFare(String dish){
    switch (dish) {
        case "1":
            this.breakfastDish = "\nBerry Burst Yogurt Parfait:Layers of creamy Greek yogurt, fresh seasonal berries, and a sprinkle of crunchy granola. Topped with a drizzle of honey for a touch of sweetness.";
            break;
